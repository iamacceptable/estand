...
<body>
    ...
    <section>
        ...
        <?php if(isset($_SESSION['loginned'])){ ?>
    			<div class="col-lg-6 col-sm-6">
    				<h3 class="font-weight-bold title-1 red-text">
    					<strong>Hello <?php echo $_SESSION['name']; ?> !!!!!!</strong>
    				</h3>
    			</div>
    			<div class="col-lg-6 col-sm-6">
    				<h4 class="text-right font-weight-bold title-1">
    					<a class="red-text" data-toggle="tooltip" data-placement="bottom" title="View My Cart">
                            <i class="fa fa-shopping-cart ml-3"></i> <span class="badge badge-success">0</span>
                        </a>
    				</h4>
    			</div>
    		</div>
    ...
    <div class="container">
        <div class="row pt-4">
        	<div class="col-lg-12 col-xs-12 text-center indigo-text">
        		<h1 class="font-weight-bold">"Explore The World of E-Stand"</h1>
        	</div>
            <!-- Content -->
            <div class="col-lg-12">
                <!-- Products Grid -->
                <section class="section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 mb-4">
                                    ...
                                    <div class="card card-ecommerce">
                                        ...
                                        <!--Card image-->
                                        <div class="view overlay">
                                            <img src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Products/4.jpg" class="img-fluid" alt="">
                                            <a>
                                                <div class="mask rgba-white-slight"></div>
                                            </a>
                                        </div>
                    ...
                    <div class="row flex-center mb-5">
                        ...
                        <p>
                            <a class="btn btn-primary btn-rounded mb-5" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                More products
                            </a>
                        </p>
                    ...
                    <div class="row flex-center mb-5">
                        ...
                        <p>
                            <a class="btn btn-primary btn-rounded mb-5" data-toggle="collapse" href="#collapseExample1" aria-expanded="false" aria-controls="collapseExample1">More products</a>
                        </p>
